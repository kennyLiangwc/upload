...
* @Last Modified time: 2018-03-16 14:59:51
* @param {String} file required
* @param {String} url 服务端处理url required
* @param {Function} progress 上传进度的回调函数
* @param {Function} success 上传成功的回调函数
* @param {Function} error 上传失败的回调函数
* @param {Object} extraData 上传额外的参数
* @param {Number} maxSize 允许上传最大的文件大小 default 50m
*/
